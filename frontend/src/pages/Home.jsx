...
export default function Home() {
  ...
  return (
    <main>
      ...
      {/* Visual Anchor (Landscape wheat field) */}
      <section ref={addToRefs} className="h-[480px] relative overflow-hidden mb-12">
        ...
        <div className="absolute inset-0 bg-primary/10 flex items-center justify-center">
          <div className="text-center text-white max-w-xl px-margin-mobile">
            <h2 className="font-display-lg text-display-lg-mobile md:text-headline-md mb-stack-sm text-white drop-shadow-sm font-semibold">
              A Lighthouse in the Digital Age
            </h2>
            <p className="font-body-lg text-sm text-white/90">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={p.title} className="group p-8 rounded-2xl bg-card border border-border/60 shadow-soft hover:shadow-divine transition-all duration-300 hover:-translate-y-1 text-left">
                <div className="w-12 h-12 rounded-xl bg-gradient-divine flex items-center justify-center mb-5 group-hover:scale-110 transition-transform shadow-sm">
      ...
      {/* Attached Section 3: Image + verse split */}
      <section ref={addToRefs} className="py-12 md:py-16 px-6 bg-card/40 border-y border-outline-variant/20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="relative rounded-3xl overflow-hidden shadow-divine h-96">
            <img src={shepherdImg} alt="Jesus the Good Shepherd carrying a lamb" loading="lazy" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="text-left">
            <p className="text-primary font-label-caps text-xs tracking-widest mb-3">THE GOOD SHEPHERD</p>
            <h2 className="font-headline-md text-4xl md:text-5xl text-primary mb-6 leading-tight">He knows your name, and He calls you His own.</h2>
